...
from config import OPENAI_API_KEY, DAILY_NOTES_PATH, LOG_PATH
...
"""
    ...
    response = client.chat.completions.create(
        model="gpt-4o",
        messages=[
            {"role": "system", "content": "You are a spiritually-aligned executive assistant that writes reflective daily summaries for your user's Obsidian vault."},

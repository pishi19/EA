...
import TreeNavigation from '../workstream-filter-demo/TreeNavigation';
import ContextPane from '../workstream-filter-demo/ContextPane';
import useTreeState from '../workstream-filter-demo/useTreeState';
import useRoadmapHierarchy from '../workstream-filter-demo/useRoadmapHierarchy';

// Import custom hooks
import { useArtefacts } from '../workstream-filter-demo/hooks/useArtefacts';
import { useArtefactFilters } from '../workstream-filter-demo/hooks/useArtefactFilters';
import { useArtefactMutations } from '../workstream-filter-demo/hooks/useArtefactMutations';
import { useBatchOperations } from '../workstream-filter-demo/hooks/useBatchOperations';
import { FilterControls } from '../workstream-filter-demo/components/FilterControls';
import { artefactService } from '../workstream-filter-demo/services/artefactService';
...
function WorkstreamFilterDemoTestInner() {
    ...
    return (
        <div className="container mx-auto p-6 space-y-6">
            ...
            <div className="text-center space-y-4">
                <h1 className="text-3xl font-bold">🏗️ Workstream Management</h1>

            ...
            if (selectedProjectData) {
                ...
                filtered = filtered.filter(artefact => {
                    ...
                    if (artefact.phase) {
                        ...
                        // But only with dot separator to avoid false positives (e.g., "14.1" should not match "15")
                        if (!phaseMatch && projectNumber && !projectNumber.includes('.')) {
                            // Only do broad matching for top-level phases like "11", not sub-projects like "11.2"
                            phaseMatch = artefactPhase.startsWith(projectNumber + '.');
                        }
                    }

...
def summarize_graph():
    ...
    with open(DASHBOARD_MD, "w") as f:
        ...
        f.write("This dashboard summarizes semantic and file-level dependencies in the EA system.\n\n")
        f.write("## 📊 Summary\n\n")
...
def visualize_graph():
    ...
    nx.draw(G, pos, with_labels=True, node_color='lightblue', node_size=500, font_size=8, font_weight='bold', arrows=True)

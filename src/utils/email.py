...
class EmailManager:
    ...
    def _create_message(self, to_emails: List[str], subject: str, body: str, html_body: Optional[str] = None) -> MIMEMultipart:
        ...
        for attempt in range(self.max_retries):
            try:
                ...
                if attempt < self.max_retries - 1:
                    logger.warning(f"Failed to send email (attempt {attempt + 1}/{self.max_retries}): {e}")
